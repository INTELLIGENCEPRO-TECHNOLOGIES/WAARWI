/*
  # Restore: exclude generated columns
  Generated columns (e.g. cash_control_lines.difference_amount) can't be
  INSERTed. We project the payload onto the live, non-generated column list
  before inserting, so the snapshot stays forward-compatible with schema
  evolution.
*/
...
BEGIN
  ...
  FOREACH v_table IN ARRAY v_insert_order LOOP
    ...
    -- Build the list of real, writable columns (exclude GENERATED ALWAYS)
