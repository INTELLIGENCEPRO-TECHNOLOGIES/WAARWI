/*
  # Fix record_cash_movement: update session theoretical_amount

  1. Changes
    - After inserting the movement, updates `cash_sessions.theoretical_amount`:
      - income/customer_prepayment: adds amount
      - expense: subtracts amount

  2. Why
    - Cash movements (expenses, incomes, prepayments) were never reflected
      in the session's theoretical balance, causing "Solde caisse" to be wrong.
*/
