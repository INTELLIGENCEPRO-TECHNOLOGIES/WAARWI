/*
  # POS sale + quote-to-invoice use per-tenant counters

  Replaces the timestamp+uuid based sale_number with the simple per-tenant counter
  format (`V-00001`, `F-00001`). The rest of the business logic is untouched.
*/
