/*
  Fix register_sale_payment: restore cash_movement creation that was lost in
  migration 20260627232707. When a payment is applied with a cash_session_id,
  a cash_movement record must be created so it appears in the session history.
*/
