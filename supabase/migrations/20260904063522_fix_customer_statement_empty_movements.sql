/*
# Robustesse du relevé client sans mouvement

Un client peut avoir un solde d'ouverture non reconstructible sans aucun
mouvement daté. Le FROM final utilise désormais une source neutre au lieu de la
CTE movements (qui pouvait être vide et renvoyer des NULL). Les sous-requêtes
scalaires restent visibles sur les CTE. Aucune autre logique ne change.
*/
