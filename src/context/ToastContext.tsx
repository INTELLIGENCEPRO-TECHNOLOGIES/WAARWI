  ...
  return (
    <Ctx.Provider value={{
      ...
      <div className="fixed top-4 right-4 z-[100] flex flex-col gap-2 w-[min(92vw,380px)]">
        {toasts.map(t => (
          <div key={t.id} className={`flex items-start gap-3 p-3.5 rounded-xl shadow-elevated border animate-slide-up ${
            ...
            {t.kind === 'info' && <Info className="w-5 h-5 text-slate-500 shrink-0 mt-0.5" />}
