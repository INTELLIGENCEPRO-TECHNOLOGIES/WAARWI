        ...
        <div className="p-2 border-b border-slate-100">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-8 pr-3 py-2 text-sm rounded-lg border border-slate-100 bg-slate-50 focus:bg-white focus:border-teal-300 focus:ring-1 focus:ring-teal-100 outline-none transition-all"
            />
          </div>
        </div>
      )}
